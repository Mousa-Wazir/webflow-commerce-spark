...
export default function CustomerDashboard() {
  ...
  return (
    <CustomerDashboardShell>
      {/* Search bar section */}
      <div className="w-full max-w-3xl mx-auto mt-5 md:mt-10">
        <SearchBar
          search={search}
          setSearch={setSearch}
      ...
      <section className="w-full max-w-5xl mx-auto mt-4 md:mt-8 flex flex-col items-center">
        <h2 className="font-bold text-2xl md:text-3xl text-gray-900 mb-5 text-center w-full">Featured Products</h2>
